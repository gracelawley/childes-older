...
## Input path ------------------------------------------------------
transcripts_in_path = here("data/processed/clark_filtered-transcripts.csv")
utterances_in_path = here("data/raw/clark_utterances.csv")
## -----------------------------------------------------------------

## Output path -----------------------------------------------------
out_path = here("data/processed/clark_filtered-utterances.csv")
## -----------------------------------------------------------------
