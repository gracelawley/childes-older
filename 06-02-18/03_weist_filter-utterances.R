...
## Input path ------------------------------------------------------
transcripts_in_path = here("data/processed/childes/weist_filtered-transcripts.csv")
utterances_in_path = here("data/raw/childes/weist_utterances.csv")
## -----------------------------------------------------------------

## Output path -----------------------------------------------------
out_path = here("data/processed/childes/weist_filtered-utterances.csv")
## -----------------------------------------------------------------
...
# Removing columns with NA issues already fixed in filtered_transcripts
raw_utterances <- raw_utterances %>% 
  select(-child, -age, -sex)
