...
## Input path ------------------------------------------------------
in_path = here("data/processed/childes/demetras-trevor_filtered-utterances.csv")
## -----------------------------------------------------------------

## Output path -----------------------------------------------------
out_path = here("data/processed/childes/demetras-trevor_proc-utterances.csv")
## -----------------------------------------------------------------


# Loading text processing function
source("R/01_data-processing/childes/functions.R")
