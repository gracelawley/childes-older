...
## Input path ------------------------------------------------------
transcripts_in_path = here("data/processed/childes/bloom1970_filtered-transcripts.csv")
utterances_in_path = here("data/raw/childes/bloom1970_utterances.csv")
## -----------------------------------------------------------------

## Output path -----------------------------------------------------
out_path = here("data/processed/childes/bloom1970_filtered-utterances.csv")
## -----------------------------------------------------------------
