...
## Input path ------------------------------------------------------
transcripts_in_path = here("data/processed/childes/ellisweismer_filtered-transcripts.csv")
utterances_in_path = here("data/raw/childes/ellisweismer_utterances.csv")
## -----------------------------------------------------------------

## Output path -----------------------------------------------------
out_path = here("data/processed/childes/ellisweismer_filtered-utterances.csv")
## -----------------------------------------------------------------
...
# Correcting collection name from Clinical-MOR to Eng-NA
raw_utterances <- raw_utterances %>%
  mutate(collection = replace(collection, 
                              collection == 'Clinical-MOR', 
                              'Eng-NA'))
