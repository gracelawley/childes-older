...
## Input path -----------------------------------------------------------------
in_path = here("data/raw/childes/demetras1_transcripts.csv")
## ----------------------------------------------------------------------------

## Output path ----------------------------------------------------------------
out_path = here("data/processed/childes/demetras1_filtered-transcripts.csv")
## ----------------------------------------------------------------------------
...
rm(list=setdiff(ls(), c("corpora", "select"))) 
